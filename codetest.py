...
#write google-sheets, thingspeak or om2m code here   
    try:
        requests.get('https://script.google.com/macros/s/' + access_csv(config_WM.device_id, "gsheets") + '/exec?timestamp=%s&total_flow=%s&rate=%s'%(str(Filename[-1][3:-4]),str(stored_value[-1]+1),str(f_rate[-1])))
    except:
...
def main():
    try:
        ...
        # set LED high
            t1 = int(time.time())
            print("bhaOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOSS9")
